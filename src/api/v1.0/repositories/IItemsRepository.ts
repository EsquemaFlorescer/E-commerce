...
export interface IItemsRepository {
  ...
  findAll(category?: string, property?: string, sort?: "asc" | "desc" | string): Promise<ItemType[]>
  findAllPagination(page: number, quantity: number, category?: string, property?: string, sort?: string): Promise<ItemType[] | Item[] | []>
